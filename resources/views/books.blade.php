        ...
        <div class="col-md-3">
            ...
            <form action="{{ route('books.search') }}" method="POST">
                <div class="input-group rounded ">
                    @csrf
                    <input name="search" id="search" type="search" class="form-control rounded border border-dark " placeholder="Wyszukaj" aria-label="Wyszukaj" aria-describedby="Wyszukaj-addon" />
...
<div class="container">
    @if(isset($books) && count($books) > 0)
        ...
        <table class="custom-table table table-bordered table-hover table-sm w-autoalign-middle rounded-4 overflow-hidden">
            <thead>
                <tr>
                    <th scope="col">#</th>
